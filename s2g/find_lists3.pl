...
% Optimized bottom-up version for improved speed
% Key improvement: process smaller patterns first to avoid redundant recursive calls
%writeln1(find_lists3a(L1,L3)),
%trace,
	%trace,
	%findall(L91,
	find_lists3_optimized(L1,[],L91,_Rest_a),%,L100),
	%trace,
	(fail%L91=[['&r', L92]]
	->(L4=_L92,Flag=true);
	(L4=L91,Flag=false)),
...
% Optimized find_lists3 functions for bottom-up processing
% These improve speed by trying smaller patterns first

% Optimized find_lists3 - bottom-up pattern detection
